  ...
  return (
    <main className="min-h-screen bg-[#F8F9FC] text-neutral-900">
      ...
      <section id="profil" className="relative isolate scroll-mt-24 overflow-hidden bg-[#F8F9FC]">
        ...
        />
        <div className="absolute inset-0 -z-10 bg-[linear-gradient(180deg,rgba(8,13,23,0.34)_0%,rgba(8,13,23,0.28)_48%,rgba(8,13,23,0.36)_82%,rgba(8,13,23,0.10)_100%)] sm:bg-[linear-gradient(180deg,rgba(8,13,23,0.34)_0%,rgba(8,13,23,0.28)_48%,rgba(8,13,23,0.42)_82%,rgba(248,249,252,0.30)_100%)]" />
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_center,rgba(15,23,42,0.02)_0%,rgba(15,23,42,0.34)_88%)]" />
        <div className="pointer-events-none absolute inset-x-0 bottom-0 z-0 h-40 bg-[linear-gradient(180deg,rgba(248,249,252,0)_0%,rgba(248,249,252,0.06)_30%,rgba(248,249,252,0.28)_58%,rgba(248,249,252,0.72)_84%,#F8F9FC_100%)] sm:h-28 sm:bg-gradient-to-b sm:from-transparent sm:via-[#F8F9FC]/35 sm:to-[#F8F9FC]" />
